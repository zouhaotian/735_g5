...
(1). At baseline, the expected value of CD4 count is 10.2 (9.43, 10.9), for a AZT-tolerant patient receiving zalcitabine with no previous AIDS diagnosis at study entry.
...
(5). When a patient has AZT failure, his expected CD4 count will be lower, compared with another AZT-tolerant patient, given the same observed time, treatment drug, AIDS diagnosis and random effect: -0.31 (-1.27, 0.60).

(6). The log hazard ratio for patients with drug zalcitabine vs. didanosine is estimated to be 0.31 (0.02, 0.60), given same latent CD4 cell count over time, indicating zalcitabine may increase CD4 count by having more severe side effects than didanosine.
